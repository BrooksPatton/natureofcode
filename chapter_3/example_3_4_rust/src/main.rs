...
fn main() {
    ...
    conf.window_setup = conf.window_setup.title("Polar to Cartesian");
    let (mut context, mut event_loop) = ContextBuilder::new("Polar to Cartesian", "Brookzerker")
        .conf(conf)
        .build()
