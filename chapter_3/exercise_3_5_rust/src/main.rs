...
fn main() {
    ...
    conf.window_setup = conf.window_setup.title("asteroids ship");
    let (mut context, mut event_loop) = ContextBuilder::new("asteroids ship", "Brookzerker")
        .conf(conf)
        .build()
